  ...
  <div class="default-header">
    <div class="container">
      <div class="row">
        ...
        <div class="logo"> <a href="index.php"><h4>ALFIA Bicycle Rental Website</h4></a></div>
        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="#">alfiasyahmadina2@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">CALL HOTLINE: </p>
              <a href="#">+6283898085546/a> </div>
...
echo "Welcome To ALFIA Bi-cycle Rental Website!";
 } ?>
          </div>
        </div>
      </div>
